...
const Modal = ({ isOpen = true, onClose, children }) => {
  ...
  return ReactDOM.createPortal(
    <div className="modal" style={{ backgroundColor: 'rgb(45 44 44 / 84%)' }}>
      <div className="mi-a sidebar-box-shadow border-grey br-10 p-10 pi-20 w-60 fixed bg-white top-50 right-50 z-99999 left-50 trans-x modal-transition modal-second">
        {children}
      </div>
    </div>,
